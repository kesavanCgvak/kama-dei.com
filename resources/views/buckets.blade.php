...
<body>
                        ...
                        <div class="col s12">
                            <ul class="collapsible popout" id="localbucket_list">
                                ...
                                @foreach ($local_collections as $key => $loc)
                                    <li data-bucket="{{ $loc->collection_name }}" class="local_parent_li">
                                        <div class="collapsible-header"><i
            ...
            $(document).on("click", "#bucket_list >  li.parent_li", function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let instance = M.Collapsible.getInstance(collapsibleHeader.closest(
                            'li'));
                        if (instance) {
                            instance.open();
                        } else {
    ...
    <script>
        ...
        function copyFile(option) {
            switch (option) {
                case 'name':
                    console.log("Copying file name:", selectedFile);
                    // Implement logic to copy file name
                    break;
                case 'path':
                    console.log("Copying file path:", `/path/to/${selectedFile}`);
                    // Implement logic to copy file path
                    break;
                case 'url':
                    console.log("Copying file URL:", `https://example.com/files/${selectedFile}`);
                    // Implement logic to copy file URL
                    break;
            }
            hideContextMenu();
        }
