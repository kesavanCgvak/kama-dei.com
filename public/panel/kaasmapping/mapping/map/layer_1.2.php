<?php
	$layer2 = \App\KaasType::where('parent_id', $baseTypeID)->where('structure_id', $mapBotRecord->structure_id)->first();
	$layer3 = \App\KaasType::where('parent_id', $layer2->id)->where('structure_id', $mapBotRecord->structure_id)->first();
	$detailLayer2Type = \App\KaasMapDetail::getData($baseDetail->id, $bot_id, $layer2->id)->get();
?>
