...
/*div.card-detail{ height:80vh; }*/
	#KAAS_Mapping table th,
	#KAAS_Mapping table td
		{font-size: 12px; }
	#KAAS_Mapping td:last-child,#KAAS_Bots th:last-child{ width:30px !important;font-size:12px; }
	#KAAS_Mapping tr.no-records-found>td{ text-align:center; color:red; font-size:16px; font-weight:bold; }
...
<div id="KAAS_Mapping"><i class="fa fa-gear fa-spin fa-5x" style="margin:auto"></i></div>
