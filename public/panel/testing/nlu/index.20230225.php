...
<form onReset="callRest()">
	<div class="divA">
		...
		<div>
			<label style="display:inline-block;margin-left:10px"> Select Portal Type:</label>
			<div class="btn-group" role="group" aria-label="Basic example">
				<button type="button" class="btn btn-default" id="btnOriginal" onClick="setPortalType(this,'originalMode')" disabled>
					 Production Mode
				</button>
				<button type="button" class="btn btn-default" id="btnTest" onClick="setPortalType(this,'testMode')" disabled>
					 Debug Mode
				</button>
			</div>
...
$(function(){ 
	...
	$("#portals").on('change', function(){
		...
		if($(this).val()!=''){
			...
			setPortalType($("#btnOriginal"), "originalMode");
