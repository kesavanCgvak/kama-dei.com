<style>
	#feedbackDIV th{ font-size: 11.5px !important; }
	#feedbackDIV td{ font-size: 11px !important; }
	#feedbackDIV td:last-child{ font-size: 9px !important; }
	
	#feedbackDIV th:nth-child(0) , #feedbackDIV td:nth-child(0) { width: 70px; }
	#feedbackDIV th:nth-child(1) , #feedbackDIV td:nth-child(1) ,
	#feedbackDIV th:nth-child(2) , #feedbackDIV td:nth-child(2) { width: 120px; }
	#feedbackDIV th:nth-child(3) , #feedbackDIV td:nth-child(3) { text-align: center; width: 90px; }
	#feedbackDIV th:nth-child(4) , #feedbackDIV td:nth-child(4) { width: 110px; }
	#feedbackDIV th:nth-child(5) , #feedbackDIV td:nth-child(5) { text-align: center; width: 65px; vertical-align: middle; }
	#feedbackDIV th:nth-child(6) , #feedbackDIV td:nth-child(6) { width: 120px; }
	#feedbackDIV th:nth-child(7) , #feedbackDIV td:nth-child(7) { width: 120px; }
	#feedbackDIV th:nth-child(8) , #feedbackDIV td:nth-child(8) { text-align: center; width: 70px; }
	#feedbackDIV th:nth-child(9) , #feedbackDIV td:nth-child(9) { width: 100px; }
	#feedbackDIV th:nth-child(10), #feedbackDIV td:nth-child(10){ text-align: center; width: 70px; vertical-align: middle; }
	/*
	...
	*/
	...
	div.chat_v.bot>.chat_b>p{ margin: 0.15rem 0.2rem;line-height: 2.2rem; word-wrap: break-word; }
	...
	<?php
	$sourceType = \App\SourceType::all();
	if(!$sourceType->isEmpty()){
		foreach($sourceType as $itm){
			echo ".class_{$itm->sender}{"."\n";
				echo "display:block;"."\n";
				echo "width:calc(100% + 1.2rem);"."\n";
				echo "background-color:{$itm->bkColor} !important;"."\n";
				echo "color:{$itm->fontColor} !important;"."\n";
				echo "padding:5px;"."\n";
				echo "margin-top:-.65rem;"."\n";
				echo "margin-left:-.6rem;"."\n";
				echo "border-radius:8px 8px 0 0;"."\n";
				echo "font-size:1.3rem;"."\n";
				echo "font-weight:bold;"."\n";
			echo "}"."\n";
			echo ".class_{$itm->sender}>.date{"."\n";
				echo "font-size:1.0rem;"."\n";
				echo "float:right;"."\n";
	...
	.class_user{ justify-content: flex-end !important; }
	.class_user>div{
		background: rgb(137, 195, 60) !important;
		color: #fff !important;
